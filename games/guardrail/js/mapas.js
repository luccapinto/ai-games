...
const DEFINICOES = [
  {
    ...
    dica: 'Rota única e longa: dá para empilhar alcance perto das curvas. O cluster é generoso aqui — é por isso que este mapa ensina a gastar VRAM sem medo.',
    vram: 26,
    dinheiro: 340,
    vidas: 20,
    piso: '#171c24',
  ...
  },
  {
    ...
    dica: 'Duas entradas, dois pipelines, um cluster só — e eles se cruzam três vezes. As células das cruzes valem por duas torres, e o cluster aqui é apertado: quantizar deixa de ser opcional.',
    vram: 22,
    dinheiro: 440,
    vidas: 20,
    piso: '#191823',
  ...
  },
  {
    ...
    dica: 'Quase tudo aqui é lago: só as duas ilhas do meio aceitam torre. Em compensação a espiral passa três vezes por perto delas. Alcance vale mais que cadência.',
    vram: 14,
    dinheiro: 420,
    vidas: 16,
    piso: '#101a22',
