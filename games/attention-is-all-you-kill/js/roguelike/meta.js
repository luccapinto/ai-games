// meta.js — progressão permanente entre runs, guardada em localStorage.
...
export const META_UPGRADES = [
  {
    ...
    desc: '+10 de contexto inicial por nível.',
    cost: 120,
    max: 3
  },
  {
    ...
    desc: '+15% de munição reserva em todas as armas.',
    cost: 100,
    max: 3
  },
  {
    ...
    desc: '+4% de velocidade de movimento por nível.',
    cost: 150,
    max: 2
  },
  {
    id: 'rlhf',
    name: 'RLHF: PREFERÊNCIA',
    desc: '+6% de dano por nível. Recompensa por ser útil.',
    cost: 200,
    max: 3
  },
  {
    ...
    desc: '+8% de chance de disparo duplo por nível.',
    cost: 350,
    max: 2
  }
];
...
export class MetaProgress {
  ...
  costOf(def) {
    ...
    // cada nível seguinte custa 1.8x mais
  ...
  // Bônus aplicados no início de cada run.
  bonus() {
    return {
  ...
  // O payout premia o que o jogador fez, não só o tempo sobrevivido: cada
  // abate, cada sala limpa e cada andar alcancado entram na conta. Antes o
  // resultado quase não reagia ao desempenho e uma run boa pagava o mesmo que
