...
escrever a primeira linha.
    ...
    python3 tools/novo_jogo.py meu-jogo --titulo "MEU JOGO" --autor "Fulana" \\
        --github fulana --modelo gpt-5 --agente aider
...
def main(argv=None):
    ...
    p.add_argument('--modelo', default='', help='ex: gpt-5, claude-opus-5, deepseek-v3')
    p.add_argument('--provider', default='', help='ex: OpenAI, Anthropic, OpenRouter')
    p.add_argument('--agente', default='', help='a ferramenta: aider, Cursor, Claude Code, chat no site...')
